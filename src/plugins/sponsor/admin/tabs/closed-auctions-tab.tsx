...
export function ClosedAuctionsTab({ admin }: { admin: SponsorshipAdmin }) {
  ...
  const {
    closedSearchQuery, setClosedSearchQuery, filteredClosedAuctions,
    selectedClosedAuctionId, setSelectedClosedAuctionId,
    selectedClosedAuction, selectedClosedAuctionWinnerName,
    selectedClosedAuctionWinningBidCents, selectedClosedAuctionInvitedSponsors,
    selectedClosedAuctionSponsorOutcomes, closedAuctionManagerView,
  } = closed
