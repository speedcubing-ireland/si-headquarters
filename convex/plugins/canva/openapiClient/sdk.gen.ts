...
import type { CreateAssetUploadJobData, CreateAssetUploadJobErrors, CreateAssetUploadJobResponses, CreateCommentData, CreateCommentErrors, CreateCommentResponses, CreateDesignAutofillJobData, CreateDesignAutofillJobErrors, CreateDesignAutofillJobResponses, CreateDesignData, CreateDesignErrors, CreateDesignExportJobData, CreateDesignExportJobErrors, CreateDesignExportJobResponses, CreateDesignImportJobData, CreateDesignImportJobErrors, CreateDesignImportJobResponses, CreateDesignMergeJobData, CreateDesignMergeJobErrors, CreateDesignMergeJobResponses, CreateDesignResizeJobData, CreateDesignResizeJobErrors, CreateDesignResizeJobResponses, CreateDesignResponses, CreateFolderData, CreateFolderErrors, CreateFolderResponses, CreateReplyData, CreateReplyErrors, CreateReplyResponses, CreateThreadData, CreateThreadErrors, CreateThreadResponses, CreateUrlAssetUploadJobData, CreateUrlAssetUploadJobErrors, CreateUrlAssetUploadJobResponses, CreateUrlImportJobData, CreateUrlImportJobErrors, CreateUrlImportJobResponses, DeleteAssetData, DeleteAssetErrors, DeleteAssetResponses, DeleteFolderData, DeleteFolderErrors, DeleteFolderResponses, ExchangeAccessTokenData, ExchangeAccessTokenErrors, ExchangeAccessTokenResponses, GetAppJwksData, GetAppJwksErrors, GetAppJwksResponses, GetAssetData, GetAssetErrors, GetAssetResponses, GetAssetUploadJobData, GetAssetUploadJobErrors, GetAssetUploadJobResponses, GetBrandTemplateData, GetBrandTemplateDatasetData, GetBrandTemplateDatasetErrors, GetBrandTemplateDatasetResponses, GetBrandTemplateErrors, GetBrandTemplateResponses, GetDesignAutofillJobData, GetDesignAutofillJobErrors, GetDesignAutofillJobResponses, GetDesignData, GetDesignErrors, GetDesignExportFormatsData, GetDesignExportFormatsErrors, GetDesignExportFormatsResponses, GetDesignExportJobData, GetDesignExportJobErrors, GetDesignExportJobResponses, GetDesignImportJobData, GetDesignImportJobErrors, GetDesignImportJobResponses, GetDesignMergeJobData, GetDesignMergeJobErrors, GetDesignMergeJobResponses, GetDesignPagesData, GetDesignPagesErrors, GetDesignPagesResponses, GetDesignResizeJobData, GetDesignResizeJobErrors, GetDesignResizeJobResponses, GetDesignResponses, GetFolderData, GetFolderErrors, GetFolderResponses, GetOidcJwksData, GetOidcJwksErrors, GetOidcJwksResponses, GetReplyData, GetReplyErrors, GetReplyResponses, GetSigningPublicKeysData, GetSigningPublicKeysErrors, GetSigningPublicKeysResponses, GetThreadData, GetThreadErrors, GetThreadResponses, GetUrlAssetUploadJobData, GetUrlAssetUploadJobErrors, GetUrlAssetUploadJobResponses, GetUrlImportJobData, GetUrlImportJobErrors, GetUrlImportJobResponses, GetUserCapabilitiesData, GetUserCapabilitiesErrors, GetUserCapabilitiesResponses, GetUserProfileData, GetUserProfileErrors, GetUserProfileResponses, IntrospectTokenData, IntrospectTokenErrors, IntrospectTokenResponses, ListBrandTemplatesData, ListBrandTemplatesErrors, ListBrandTemplatesResponses, ListDesignsData, ListDesignsErrors, ListDesignsResponses, ListFolderItemsData, ListFolderItemsErrors, ListFolderItemsResponses, ListRepliesData, ListRepliesErrors, ListRepliesResponses, MoveFolderItemData, MoveFolderItemErrors, MoveFolderItemResponses, RevokeTokensData, RevokeTokensErrors, RevokeTokensResponses, UpdateAssetData, UpdateAssetErrors, UpdateAssetResponses, UpdateFolderData, UpdateFolderErrors, UpdateFolderResponses, UserInfoData, UserInfoErrors, UserInfoResponses, UsersMeData, UsersMeErrors, UsersMeResponses } from './types.gen';
 ...
 */
export const getAppJwks = <ThrowOnError extends boolean = false>(options: Options<GetAppJwksData, ThrowOnError>): RequestResult<GetAppJwksResponses, GetAppJwksErrors, ThrowOnError> => (options.client ?? client).get<GetAppJwksResponses, GetAppJwksErrors, ThrowOnError>({ url: '/v1/apps/{appId}/jwks', ...options });
 ...
 * </Note>
 */
export const createAssetUploadJob = <ThrowOnError extends boolean = false>(options: Options<CreateAssetUploadJobData, ThrowOnError>): RequestResult<CreateAssetUploadJobResponses, CreateAssetUploadJobErrors, ThrowOnError> => (options.client ?? client).post<CreateAssetUploadJobResponses, CreateAssetUploadJobErrors, ThrowOnError>({
    bodySerializer: null,
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getAssetUploadJob = <ThrowOnError extends boolean = false>(options: Options<GetAssetUploadJobData, ThrowOnError>): RequestResult<GetAssetUploadJobResponses, GetAssetUploadJobErrors, ThrowOnError> => (options.client ?? client).get<GetAssetUploadJobResponses, GetAssetUploadJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const createUrlAssetUploadJob = <ThrowOnError extends boolean = false>(options: Options<CreateUrlAssetUploadJobData, ThrowOnError>): RequestResult<CreateUrlAssetUploadJobResponses, CreateUrlAssetUploadJobErrors, ThrowOnError> => (options.client ?? client).post<CreateUrlAssetUploadJobResponses, CreateUrlAssetUploadJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getUrlAssetUploadJob = <ThrowOnError extends boolean = false>(options: Options<GetUrlAssetUploadJobData, ThrowOnError>): RequestResult<GetUrlAssetUploadJobResponses, GetUrlAssetUploadJobErrors, ThrowOnError> => (options.client ?? client).get<GetUrlAssetUploadJobResponses, GetUrlAssetUploadJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createDesignAutofillJob = <ThrowOnError extends boolean = false>(options?: Options<CreateDesignAutofillJobData, ThrowOnError>): RequestResult<CreateDesignAutofillJobResponses, CreateDesignAutofillJobErrors, ThrowOnError> => (options?.client ?? client).post<CreateDesignAutofillJobResponses, CreateDesignAutofillJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/autofills',
    ...options,
    headers: {
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getDesignAutofillJob = <ThrowOnError extends boolean = false>(options: Options<GetDesignAutofillJobData, ThrowOnError>): RequestResult<GetDesignAutofillJobResponses, GetDesignAutofillJobErrors, ThrowOnError> => (options.client ?? client).get<GetDesignAutofillJobResponses, GetDesignAutofillJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listBrandTemplates = <ThrowOnError extends boolean = false>(options?: Options<ListBrandTemplatesData, ThrowOnError>): RequestResult<ListBrandTemplatesResponses, ListBrandTemplatesErrors, ThrowOnError> => (options?.client ?? client).get<ListBrandTemplatesResponses, ListBrandTemplatesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getBrandTemplate = <ThrowOnError extends boolean = false>(options: Options<GetBrandTemplateData, ThrowOnError>): RequestResult<GetBrandTemplateResponses, GetBrandTemplateErrors, ThrowOnError> => (options.client ?? client).get<GetBrandTemplateResponses, GetBrandTemplateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * WARNING: Chart data fields are a [preview feature](https://www.canva.dev/docs/connect/#preview-apis). There might be unannounced breaking changes to this feature which won't produce a new API version.
 */
export const getBrandTemplateDataset = <ThrowOnError extends boolean = false>(options: Options<GetBrandTemplateDatasetData, ThrowOnError>): RequestResult<GetBrandTemplateDatasetResponses, GetBrandTemplateDatasetErrors, ThrowOnError> => (options.client ?? client).get<GetBrandTemplateDatasetResponses, GetBrandTemplateDatasetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listReplies = <ThrowOnError extends boolean = false>(options: Options<ListRepliesData, ThrowOnError>): RequestResult<ListRepliesResponses, ListRepliesErrors, ThrowOnError> => (options.client ?? client).get<ListRepliesResponses, ListRepliesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * [Canva Help Center](https://www.canva.com/help/comments/).
 */
export const createReply = <ThrowOnError extends boolean = false>(options: Options<CreateReplyData, ThrowOnError>): RequestResult<CreateReplyResponses, CreateReplyErrors, ThrowOnError> => (options.client ?? client).post<CreateReplyResponses, CreateReplyErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/designs/{designId}/comments/{threadId}/replies',
    ...options,
    headers: {
 ...
 * [Canva Help Center](https://www.canva.com/help/comments/).
 */
export const getReply = <ThrowOnError extends boolean = false>(options: Options<GetReplyData, ThrowOnError>): RequestResult<GetReplyResponses, GetReplyErrors, ThrowOnError> => (options.client ?? client).get<GetReplyResponses, GetReplyErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getSigningPublicKeys = <ThrowOnError extends boolean = false>(options?: Options<GetSigningPublicKeysData, ThrowOnError>): RequestResult<GetSigningPublicKeysResponses, GetSigningPublicKeysErrors, ThrowOnError> => (options?.client ?? client).get<GetSigningPublicKeysResponses, GetSigningPublicKeysErrors, ThrowOnError>({ url: '/v1/connect/keys', ...options });
 ...
 * - Sort the results.
 */
export const listDesigns = <ThrowOnError extends boolean = false>(options?: Options<ListDesignsData, ThrowOnError>): RequestResult<ListDesignsResponses, ListDesignsErrors, ThrowOnError> => (options?.client ?? client).get<ListDesignsResponses, ListDesignsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/designs',
    ...options
});
 ...
 */
export const createDesign = <ThrowOnError extends boolean = false>(options?: Options<CreateDesignData, ThrowOnError>): RequestResult<CreateDesignResponses, CreateDesignErrors, ThrowOnError> => (options?.client ?? client).post<CreateDesignResponses, CreateDesignErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/designs',
    ...options,
    headers: {
 ...
 */
export const getDesign = <ThrowOnError extends boolean = false>(options: Options<GetDesignData, ThrowOnError>): RequestResult<GetDesignResponses, GetDesignErrors, ThrowOnError> => (options.client ?? client).get<GetDesignResponses, GetDesignErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getDesignPages = <ThrowOnError extends boolean = false>(options: Options<GetDesignPagesData, ThrowOnError>): RequestResult<GetDesignPagesResponses, GetDesignPagesErrors, ThrowOnError> => (options.client ?? client).get<GetDesignPagesResponses, GetDesignPagesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const getDesignExportFormats = <ThrowOnError extends boolean = false>(options: Options<GetDesignExportFormatsData, ThrowOnError>): RequestResult<GetDesignExportFormatsResponses, GetDesignExportFormatsErrors, ThrowOnError> => (options.client ?? client).get<GetDesignExportFormatsResponses, GetDesignExportFormatsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const createDesignImportJob = <ThrowOnError extends boolean = false>(options: Options<CreateDesignImportJobData, ThrowOnError>): RequestResult<CreateDesignImportJobResponses, CreateDesignImportJobErrors, ThrowOnError> => (options.client ?? client).post<CreateDesignImportJobResponses, CreateDesignImportJobErrors, ThrowOnError>({
    bodySerializer: null,
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/imports',
    ...options,
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getDesignImportJob = <ThrowOnError extends boolean = false>(options: Options<GetDesignImportJobData, ThrowOnError>): RequestResult<GetDesignImportJobResponses, GetDesignImportJobErrors, ThrowOnError> => (options.client ?? client).get<GetDesignImportJobResponses, GetDesignImportJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const createUrlImportJob = <ThrowOnError extends boolean = false>(options: Options<CreateUrlImportJobData, ThrowOnError>): RequestResult<CreateUrlImportJobResponses, CreateUrlImportJobErrors, ThrowOnError> => (options.client ?? client).post<CreateUrlImportJobResponses, CreateUrlImportJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/url-imports',
    ...options,
    headers: {
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getUrlImportJob = <ThrowOnError extends boolean = false>(options: Options<GetUrlImportJobData, ThrowOnError>): RequestResult<GetUrlImportJobResponses, GetUrlImportJobErrors, ThrowOnError> => (options.client ?? client).get<GetUrlImportJobResponses, GetUrlImportJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const createDesignExportJob = <ThrowOnError extends boolean = false>(options?: Options<CreateDesignExportJobData, ThrowOnError>): RequestResult<CreateDesignExportJobResponses, CreateDesignExportJobErrors, ThrowOnError> => (options?.client ?? client).post<CreateDesignExportJobResponses, CreateDesignExportJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/exports',
    ...options,
    headers: {
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getDesignExportJob = <ThrowOnError extends boolean = false>(options: Options<GetDesignExportJobData, ThrowOnError>): RequestResult<GetDesignExportJobResponses, GetDesignExportJobErrors, ThrowOnError> => (options.client ?? client).get<GetDesignExportJobResponses, GetDesignExportJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listFolderItems = <ThrowOnError extends boolean = false>(options: Options<ListFolderItemsData, ThrowOnError>): RequestResult<ListFolderItemsResponses, ListFolderItemsErrors, ThrowOnError> => (options.client ?? client).get<ListFolderItemsResponses, ListFolderItemsErrors, ThrowOnError>({
    querySerializer: { parameters: { item_types: { array: { explode: false } } } },
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const moveFolderItem = <ThrowOnError extends boolean = false>(options?: Options<MoveFolderItemData, ThrowOnError>): RequestResult<MoveFolderItemResponses, MoveFolderItemErrors, ThrowOnError> => (options?.client ?? client).post<MoveFolderItemResponses, MoveFolderItemErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/folders/move',
    ...options,
    headers: {
 ...
 * </Note>
 */
export const createDesignMergeJob = <ThrowOnError extends boolean = false>(options: Options<CreateDesignMergeJobData, ThrowOnError>): RequestResult<CreateDesignMergeJobResponses, CreateDesignMergeJobErrors, ThrowOnError> => (options.client ?? client).post<CreateDesignMergeJobResponses, CreateDesignMergeJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/merges',
    ...options,
    headers: {
 ...
 * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getDesignMergeJob = <ThrowOnError extends boolean = false>(options: Options<GetDesignMergeJobData, ThrowOnError>): RequestResult<GetDesignMergeJobResponses, GetDesignMergeJobErrors, ThrowOnError> => (options.client ?? client).get<GetDesignMergeJobResponses, GetDesignMergeJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/merges/{jobId}',
    ...options
});
 ...
 * This endpoint can't be called from a user's web-browser client because it uses client authentication with client secrets. Requests must come from your integration's backend, otherwise they'll be blocked by Canva's [Cross-Origin Resource Sharing (CORS)](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) policy.
 */
export const revokeTokens = <ThrowOnError extends boolean = false>(options: Options<RevokeTokensData, ThrowOnError>): RequestResult<RevokeTokensResponses, RevokeTokensErrors, ThrowOnError> => (options.client ?? client).post<RevokeTokensResponses, RevokeTokensErrors, ThrowOnError>({
    ...urlSearchParamsBodySerializer,
    security: [{ scheme: 'basic', type: 'http' }],
    url: '/v1/oauth/revoke',
    ...options,
 ...
 */
export const getOidcJwks = <ThrowOnError extends boolean = false>(options?: Options<GetOidcJwksData, ThrowOnError>): RequestResult<GetOidcJwksResponses, GetOidcJwksErrors, ThrowOnError> => (options?.client ?? client).get<GetOidcJwksResponses, GetOidcJwksErrors, ThrowOnError>({ url: '/v1/oidc/jwks', ...options });
 ...
 */
export const userInfo = <ThrowOnError extends boolean = false>(options?: Options<UserInfoData, ThrowOnError>): RequestResult<UserInfoResponses, UserInfoErrors, ThrowOnError> => (options?.client ?? client).get<UserInfoResponses, UserInfoErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * </Note>
 */
export const createDesignResizeJob = <ThrowOnError extends boolean = false>(options?: Options<CreateDesignResizeJobData, ThrowOnError>): RequestResult<CreateDesignResizeJobResponses, CreateDesignResizeJobErrors, ThrowOnError> => (options?.client ?? client).post<CreateDesignResizeJobResponses, CreateDesignResizeJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/resizes',
    ...options,
    headers: {
 ...
 * see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
 */
export const getDesignResizeJob = <ThrowOnError extends boolean = false>(options: Options<GetDesignResizeJobData, ThrowOnError>): RequestResult<GetDesignResizeJobResponses, GetDesignResizeJobErrors, ThrowOnError> => (options.client ?? client).get<GetDesignResizeJobResponses, GetDesignResizeJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const usersMe = <ThrowOnError extends boolean = false>(options?: Options<UsersMeData, ThrowOnError>): RequestResult<UsersMeResponses, UsersMeErrors, ThrowOnError> => (options?.client ?? client).get<UsersMeResponses, UsersMeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/users/me',
    ...options
});
 ...
 */
export const getUserCapabilities = <ThrowOnError extends boolean = false>(options?: Options<GetUserCapabilitiesData, ThrowOnError>): RequestResult<GetUserCapabilitiesResponses, GetUserCapabilitiesErrors, ThrowOnError> => (options?.client ?? client).get<GetUserCapabilitiesResponses, GetUserCapabilitiesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
