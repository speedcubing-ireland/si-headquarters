 ...
 * programmatically.
 */
export type AssetUploadErrorCode = 'file_too_big' | 'import_failed' | 'fetch_failed';
...
export type AutofillErrorCode = 'autofill_error' | 'thumbnail_generation_error' | 'create_design_error' | 'design_approval_error' | 'trial_quota_exceeded';
 ...
 */
export type Capability = 'autofill' | 'brand_template' | 'export_png_transparency' | 'resize' | 'team_restricted_app';
 ...
 * @deprecated
 */
export type CommentEventTypeEnum = 'comment' | 'reply' | 'mention' | 'assign' | 'resolve';
 ...
 */
export type SuggestionFormat = 'font_family' | 'font_size' | 'font_weight' | 'font_style' | 'color' | 'background_color' | 'decoration' | 'strikethrough' | 'link' | 'letter_spacing' | 'line_height' | 'direction' | 'text_align' | 'list_marker' | 'list_level' | 'margin_inline_start' | 'text_indent' | 'font_size_modifier' | 'vertical_align';
 ...
 */
export type ColumnDataType = 'string' | 'number' | 'date' | 'boolean' | 'media' | 'variant';
 ...
 */
export type DataTableImageMimeType = 'image/jpeg' | 'image/heic' | 'image/png' | 'image/svg+xml' | 'image/webp' | 'image/tiff';

/**
 * The MIME type of a video file that's supported by Canva's backend.
 */
export type DataTableVideoMimeType = 'video/avi' | 'video/x-msvideo' | 'image/gif' | 'video/x-m4v' | 'video/x-matroska' | 'video/quicktime' | 'video/mp4' | 'video/mpeg' | 'video/webm' | 'application/json';

/**
 * A disclosure identifying if the app generated this media asset using AI.
 */
export type DataTableAiDisclosure = 'app_generated' | 'none';

export type SortByType = 'relevance' | 'modified_descending' | 'modified_ascending' | 'title_descending' | 'title_ascending';
 ...
 * programmatically.
 */
export type DesignImportErrorCode = 'design_creation_throttled' | 'design_import_throttled' | 'duplicate_import' | 'internal_error' | 'invalid_file' | 'fetch_failed';
 ...
 */
export type PresetDesignTypeName = 'doc' | 'email' | 'presentation' | 'whiteboard';
 ...
 *
 */
export type ErrorCode = 'internal_error' | 'invalid_field' | 'invalid_header_value' | 'permission_denied' | 'too_many_requests' | 'not_found' | 'bad_request_body' | 'bad_http_method' | 'bad_request_params' | 'bad_query_params' | 'user_role_required' | 'endpoint_not_found' | 'endpoint_gone' | 'unsupported_version' | 'invalid_access_token' | 'revoked_access_token' | 'missing_field' | 'missing_scope' | 'invalid_grant' | 'invalid_request' | 'invalid_client' | 'unauthorized_client' | 'unsupported_grant_type' | 'invalid_scope' | 'invalid_basic_header' | 'invalid_file_format' | 'quota_exceeded' | 'unsupported_content_type' | 'request_too_large' | 'folder_not_found' | 'item_in_multiple_folders' | 'asset_not_found' | 'max_limit_reached' | 'permission_not_found' | 'permission_exists' | 'unauthorized_user' | 'user_not_found' | 'group_not_found' | 'app_not_found' | 'app_has_non_draft_versions' | 'invalid_status_transition' | 'translation_validation_failed' | 'content_not_found' | 'doctype_not_found' | 'design_not_found' | 'offset_too_large' | 'page_not_found' | 'design_or_comment_not_found' | 'design_or_thread_not_found' | 'design_type_not_found' | 'team_not_found' | 'comment_not_found' | 'too_many_comments' | 'too_many_replies' | 'message_too_long' | 'thread_not_found' | 'reply_not_found' | 'design_not_fillable' | 'autofill_data_invalid' | 'feature_not_available' | 'license_required' | 'input_unsafe' | 'display_name_unavailable' | 'user_not_managed';
 ...
 */
export type ExportErrorCode = 'license_required' | 'approval_required' | 'internal_failure';
...
export type FolderItemSortBy = 'created_ascending' | 'created_descending' | 'modified_ascending' | 'modified_descending' | 'title_ascending' | 'title_descending';
 ...
 */
export type FolderItemPinStatus = 'any' | 'pinned';
...
export type DesignMergeJobStatus = 'in_progress' | 'success' | 'failed';

export type DesignMergeJobResult = {
    design: DesignSummary;
};

export type DesignMergeErrorCode = 'thumbnail_generation_error' | 'merge_error' | 'create_design_error' | 'modify_design_error';
...
export type DesignResizeErrorCode = 'thumbnail_generation_error' | 'design_resize_error' | 'create_design_error' | 'trial_quota_exceeded';
...
export type CreateUrlAssetUploadJobError = CreateUrlAssetUploadJobErrors[keyof CreateUrlAssetUploadJobErrors];
...
export type CreateUrlAssetUploadJobResponse2 = CreateUrlAssetUploadJobResponses[keyof CreateUrlAssetUploadJobResponses];
...
export type GetUrlAssetUploadJobError = GetUrlAssetUploadJobErrors[keyof GetUrlAssetUploadJobErrors];
...
export type GetUrlAssetUploadJobResponse2 = GetUrlAssetUploadJobResponses[keyof GetUrlAssetUploadJobResponses];
...
export type ListRepliesResponse2 = ListRepliesResponses[keyof ListRepliesResponses];
...
export type CreateThreadResponse2 = CreateThreadResponses[keyof CreateThreadResponses];
...
export type CreateUrlImportJobError = CreateUrlImportJobErrors[keyof CreateUrlImportJobErrors];
...
export type CreateUrlImportJobResponse2 = CreateUrlImportJobResponses[keyof CreateUrlImportJobResponses];
...
export type GetUrlImportJobError = GetUrlImportJobErrors[keyof GetUrlImportJobErrors];
...
export type GetUrlImportJobResponse2 = GetUrlImportJobResponses[keyof GetUrlImportJobResponses];
...
export type CreateDesignMergeJobError = CreateDesignMergeJobErrors[keyof CreateDesignMergeJobErrors];
...
export type CreateDesignMergeJobResponse2 = CreateDesignMergeJobResponses[keyof CreateDesignMergeJobResponses];
...
export type GetDesignMergeJobError = GetDesignMergeJobErrors[keyof GetDesignMergeJobErrors];
...
export type GetDesignMergeJobResponse2 = GetDesignMergeJobResponses[keyof GetDesignMergeJobResponses];
...
export type GetOidcJwksResponse = GetOidcJwksResponses[keyof GetOidcJwksResponses];
...
export type CreateDesignResizeJobError = CreateDesignResizeJobErrors[keyof CreateDesignResizeJobErrors];
...
export type CreateDesignResizeJobResponse2 = CreateDesignResizeJobResponses[keyof CreateDesignResizeJobResponses];
...
export type GetDesignResizeJobError = GetDesignResizeJobErrors[keyof GetDesignResizeJobErrors];
...
export type GetDesignResizeJobResponse2 = GetDesignResizeJobResponses[keyof GetDesignResizeJobResponses];
...
export type GetUserCapabilitiesError = GetUserCapabilitiesErrors[keyof GetUserCapabilitiesErrors];
...
export type GetUserCapabilitiesResponse2 = GetUserCapabilitiesResponses[keyof GetUserCapabilitiesResponses];
