...
export type ClientOptions = {
    baseUrl: 'https://api.integrations.canva.actions.com/rest' | (string & {});
};
 ...
 */
export type Capability = 'autofill' | 'brand_template' | 'resize' | 'team_restricted_app';
...
export type CreateReplyDeprecatedError = CreateReplyDeprecatedErrors[keyof CreateReplyDeprecatedErrors];
...
export type CreateReplyDeprecatedResponse = CreateReplyDeprecatedResponses[keyof CreateReplyDeprecatedResponses];
